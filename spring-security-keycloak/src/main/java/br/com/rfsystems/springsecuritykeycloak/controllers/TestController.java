package br.com.rfsystems.springsecuritykeycloak.controllers;
...
public class TestController {
    ...
    String hasAdmnin() {
        return String.format("""
				<h1>Private route, only authorized personal, has admin role! 🔐  </h1>
				""");
    }
    ...
    String hasuser() {
        return String.format("""
				<h1>Private route, only authorized personal, has user role! 🔐  </h1>
				""");
    }
